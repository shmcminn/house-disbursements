...
sunlightFileNames = ["2009Q3-detail.csv",
"2009Q4-detail.csv",
"2010Q1-detail.csv",
"2010Q2-detail.csv",
"2010Q3-detail.csv",
...
#ADD NEW FILES FROM THE HOUSE TO LIST BELOW
...
for fn in sunlightFileNames:
	...
	outputFileName = os.path.splitext(fn)[0] + "_modified.csv"
...
# adds column to show which document data came from
fieldnames.append("DOCUMENT_FILE")

# Then copy the data
with open("master_spending.csv", "w", newline="", encoding = "ISO-8859-1") as f_out:   # Comment 2 below
  ...
  for filename in all_files:
    with open(filename, "r", newline="", encoding = "ISO-8859-1") as f_in:
      ...
      for line in reader:
   		line["DOCUMENT_FILE"] = filename # fills column to show which document data came from
      	# Comment 3 below
